...
class MD5
{
    ...
    public static function hash(s, ifUpperCase:Boolean):String
    {
        var str:String = hex_md5(s);
    ...
    /**
        * Private methods
        */
    private static function hex_md5(s)
    {
        return binl2hex(core_md5(str2binl(s), s.length * chrsz));
    }
    private static function b64_md5(s)
    {
        return binl2b64(core_md5(str2binl(s), s.length * chrsz));
    }
    private static function str_md5(s)
    {
